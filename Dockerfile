...
ARG PACKAGES="gcc libc-dev musl-dev jpeg-dev zlib-dev libffi-dev cairo-dev pango-dev gdk-pixbuf-dev"
...
ARG PACKAGES="bash sudo docker git openssh-client ca-certificates rsync curl net-tools shadow vim unzip tar jq"
